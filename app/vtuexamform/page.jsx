          ...
          <div id="form-content" className="p-8">
            ...
            <div className="text-center mb-8 pb-4 border-b-2 border-black">
              <img
                src="/logo.png"
                alt="GEC Bidar Logo"
                className="h-[50px] w-[60px] mb-[2px] m-auto"
                ...
                {[
                  ...
                  <div key={field} className="relative">
                    ...
                    <input
                      ...
                      className="w-full border-0 border-b border-gray-300 focus:border-blue-500 focus:outline-none pb-1 text-sm bg-transparent transition-colors text-black"
